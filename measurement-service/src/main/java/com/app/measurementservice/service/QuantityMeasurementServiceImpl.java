...
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
    ...
    public QuantityMeasurementDTO compare(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO) {
        ...
        try {
            if (!q1.getUnit().getMeasurementType().equals(q2.getUnit().getMeasurementType())) {
                throw new QuantityMeasurementException("compare Error: Different measurement types");
            }
    ...
    public QuantityMeasurementDTO convert(QuantityDTO thisQuantityDTO, QuantityDTO targetUnitDTO) {
        ...
        try {
            double result = (source.getUnit() instanceof com.app.measurementservice.unit.TemperatureUnit)
    ...
    private IMeasurable getModelUnit(String measurementType, String unit) {
        switch (measurementType) {
            case "LengthUnit": return com.app.measurementservice.unit.LengthUnit.valueOf(unit);
            case "WeightUnit": return com.app.measurementservice.unit.WeightUnit.valueOf(unit);
            case "VolumeUnit": return com.app.measurementservice.unit.VolumeUnit.valueOf(unit);
            case "TemperatureUnit": return com.app.measurementservice.unit.TemperatureUnit.valueOf(unit);
